...
disp(['Optimal X is :  ( X_1 = ' num2str(double(X_new(1))) '   X_2 = ' num2str(double(X_new(2))) ' )   And Optimal f is : ( ' num2str(double(f(X_new(1),X_new(2)))) ' )   and the Start point is : ( x_1 = ' num2str(double(Start_Point(1))) '   x_2 = ' num2str(double(Start_Point(2))) ' )'  ]) ;
